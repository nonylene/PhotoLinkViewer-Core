...
do
    ...
    ./gradlew --quiet -PpreDexEnable=false -Pcom.android.build.threadPoolSize=1 --stacktrace clean :PhotoLinkViewerTest:connectedAndroidTest && break      # substitute your command here
    c=$?
    echo $n test errored.
    adb emu kill
